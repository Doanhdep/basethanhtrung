...
public class AdminMarketingViewModel
{
    ...
    public string BannerImage1 { get; set; } = "/assets/img/satthep.jpg";
    public string BannerImage2 { get; set; } = "/assets/img/dongnhom.jpg";
    public string BannerImage3 { get; set; } = "/assets/img/maymoc.jpg";

    public string Phone { get; set; } = "0974640626";
    public string Zalo { get; set; } = "zalo.me/0974640626";
    ...
    public string OgImage { get; set; } = "/assets/img/satthep.jpg";
}
